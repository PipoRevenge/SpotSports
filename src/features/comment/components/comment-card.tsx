...
import {
  Comment,
  CommentSourceType,
} from "@/src/entities/comment/model/comment";
...
export const CommentCard: React.FC<CommentCardProps> = memo(
  ({
    ...
    const handleVoteChange = useCallback(
      (newLikes: number, newDislikes: number) => {
            ...
            <VStack className="flex-1 gap-1">
              ...
              <HStack className="gap-2 items-center pt-2 flex-wrap">
                ...
                >
                  ...
                  <Text
                    className={`text-xs font-medium ${
                      voteState.isLiked ? "text-blue-600" : "text-gray-400"
                    }`}
                  >
                    {likesCount}
                  </Text>
                ...
                >
                  ...
                  <Text
                    className={`text-xs font-medium ${
                      voteState.isDisliked ? "text-red-600" : "text-gray-400"
                    }`}
                  >
                    {dislikesCount}
                  </Text>
                ...
                {comment.commentsCount > 0 && (
                  ...
                  >
                    ...
                    <Text className="text-xs font-medium text-gray-500">
                      ...
                      {comment.commentsCount === 1 ? "reply" : "replies"}
                    </Text>
                  </Pressable>
                )}

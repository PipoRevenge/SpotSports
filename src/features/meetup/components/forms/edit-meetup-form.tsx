...
export const EditMeetupForm: React.FC<EditMeetupFormProps> = ({
  spotId,
  meetup,
  onSuccess,
}) => {
  ...
  const handleUpdateDetails = async () => {
    ...
    if (meetup.type === MeetupType.CASUAL) {
      payload.minParticipants = minParticipants
        ? parseInt(minParticipants)
        : undefined;
      payload.participantLimit = participantLimit
        ? parseInt(participantLimit)
        : undefined;
    }
        ...
        <VStack space="md">
          ...
          <VStack space="xs">
            ...
            <Select
              ...
              onValueChange={(v) => setVisibility(v as MeetupVisibility)}
            >
              <SelectTrigger
                variant="outline"
                size="md"
